    ...
    <div className="navbar bg-primary text-primary-content mb-8">
      <div className="container mx-auto">
        <div className="flex-1">
          <Link to="/" className="btn btn-ghost text-xl">Name Collection App</Link>
        </div>
        <div className="flex-none">
          <ul className="menu menu-horizontal px-1">
            ...
            <li>
              <Link to="/names" className={location.pathname === '/names' ? 'active' : ''}>
                View Names
              </Link>
            </li>
            <li>
              <button className="swap swap-rotate" data-toggle-theme="light,dark" data-act-class="swap-active">
